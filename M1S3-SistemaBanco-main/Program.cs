...
ClienteServicos.clientes.Add(new PessoaFisica("Fernando", "123456", "Fernando@email","123", "rua",
            new DateTime(2002, 5, 15), 2));
            
ClienteServicos.clientes.Add(new PessoaFisica("Vanessa", "123456", "Vanessa@email","123", "rua",
            new DateTime(2002, 5, 15), 3));

ClienteServicos.clientes.Add(new PessoaFisica("Lucas", "123456", "Lucas@email","123", "rua",
...
do
{
  ...
  if (opcao == "1")
  {
        ...
        clienteServicos.CriarConta(tipoConta);
  }

  else if (opcao == "5")
  {
        clienteServicos.ExibirClientes();
  }
  else if (opcao == "2")
  {
    AdicionarTransacao();
